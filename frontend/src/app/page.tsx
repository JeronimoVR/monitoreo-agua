...
export default function WelcomePage() {
  return (
    <main className="min-h-screen bg-[#F9F9FF] flex flex-col px-6 py-4 font-sans selection:bg-blue-100">
      ...
      {/* Header con Branding */}
      <header className="py-3 flex items-center gap-2 max-w-7xl mx-auto w-full">
      ...
      {/* Contenido Principal */}
      <div className="flex-1 w-full max-w-7xl mx-auto pt-4 pb-8">

        {/* WEB: Grid 2 columnas (lg en adelante) */}
        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start">
          ...
          <div className="flex flex-col gap-6">
            {/* Título */}
            <section>
              <h1 className="font-extrabold tracking-tight text-[#111827] text-5xl">
                Monitoreo del agua
              </h1>
              <p className="mt-3 text-[#6B7280] text-lg">
                Calidad del agua monitoreada mediante sensores en tiempo real.
              </p>
            </section>

            {/* Card IRCA */}
            <section className="bg-[#F0F2FA] rounded-3xl p-6 border border-[#E2E6F5]">
              <h2 className="font-semibold text-[#374151] text-xl">
                ¿Quieres conocer el estado del agua del arroyo?
              </h2>
              <p className="mt-2 text-[#4B5563]">
                Regístrate para mantenerte informado sobre alteraciones en el IRCA.
              </p>
            </section>
          ...
          <div className="flex flex-col items-center justify-start sticky top-4">
            <div className="relative w-full max-w-[500px] aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="/arroyo.jpg"
            ...
            <p className="mt-3 text-center text-[#6B7280] text-sm">
              Punto de Monitoreo: Arroyo Sede Sur UNIAJC.
            </p>
          </div>
        </div>

        {/* MÓVIL: Layout vertical (visible solo en móvil) */}
        <div className="lg:hidden flex flex-col gap-6">
          {/* Título */}
          <section className="text-center">
            <h1 className="font-extrabold tracking-tight text-[#111827] text-4xl">
              Monitoreo del agua
            </h1>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-center text-[#6B7280] text-xs">
              Punto de Monitoreo: Arroyo Sede Sur UNIAJC.
            </p>
          </div>

          {/* Card IRCA */}
          <section className="bg-[#F0F2FA] rounded-2xl p-5 border border-[#E2E6F5]">
            <h2 className="font-semibold text-[#374151] text-lg">
              ¿Quieres conocer el estado del agua del arroyo?
            </h2>
